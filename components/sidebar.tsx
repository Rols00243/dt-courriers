...
export function Sidebar() {
  ...
  // Ferme le drawer au changement de page (mobile)
  useEffect(() => {
    close()
  }, [pathname, close])
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "flex flex-col w-64 bg-gray-900 dark:bg-gray-950 border-r border-gray-800 text-white",
          "fixed md:sticky top-0 left-0 z-40 h-screen transition-transform duration-200",
      ...
      >
        <div className="p-5 flex items-center gap-3 border-b border-gray-800">
          ...
          <Button
            ...
            size="sm"
            onClick={close}
            className="md:hidden text-gray-400 hover:text-white hover:bg-gray-800 -mr-2"
          >
            <X className="h-4 w-4" />
          </Button>
        </div>
